...
function LogParameters(value, context) {
    return function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        console.log("Arguments for ".concat(String(context.name), ":"), args);
...
var UserService = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            UserService.prototype.greet = function (message) {
        ...
        (function () {
            ...
            _greet_decorators = [LogParameters];
...
new UserService().greet("TypeScript learner");
